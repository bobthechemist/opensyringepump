...
*/
hwM3 = [6.2, 3.0, 2.4]; // M3 metric actual [6.2, 3.0, 2.4]
hw25 = [12.5, 5.8, 6.6, 4.1]; // 1/4"-20 actual [12.8, 6.4, 5.74, 4.17]
...
build_mode = true;  // Set to false if trying to view the entire project.
